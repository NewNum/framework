...
import com.huxh.framework.common.callback.PermissionListener
import com.huxh.framework.common.callback.RequestLifecycle
 ...
 */
open class BaseFragment : Fragment(), RequestLifecycle, BasePresenter {
    override fun bye() {
