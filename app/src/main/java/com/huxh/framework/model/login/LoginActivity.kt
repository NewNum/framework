...
package com.huxh.framework.model.login
...
import com.huxh.net.response.LoginData
 ...
 */
class LoginActivity : BaseActivity(), Contract.LoginPresenter, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private lateinit var loginView: Contract.LoginView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_login)
        loginView = LoginView(this, this)
...
//            mAuthTask!!.execute(null as Void?)
            addSubscribe(apiService.login(emailStr, passwordStr).compose(RxUtils.SchedulerTransformer())
                    .subscribeWith(object : BaseObserver<LoginData>(loginView) {
                        override fun onSuccess(loginData: LoginData?) {
                            SPUtil.setLoginStatus(true)
                            SPUtil.setLoginAccount(loginData?.username)
                        }
...
/*        val cursor = contentResolver.query(ContactsContract.Profile.CONTENT_URI, ProfileQuery.PROJECTION, ContactsContract.Contacts.Data.MIMETYPE + " = ?",
