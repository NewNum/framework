...
package com.app.framework.net.utils;
...
public class CommonUtils {
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) App.context.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
