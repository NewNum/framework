...
public final class SpanUtils {
    ...
    static class CustomLineHeightSpan implements LineHeightSpan {
        ...
        public void chooseHeight(final CharSequence text, final int start, final int end,
            ...
            LogUtils.e(TAG,fm.toString()+ sfm.toString());
        }
    }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(App.context.getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            App.context.getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(App.context.getResources(), bitmap);
                    drawable.setBounds(
